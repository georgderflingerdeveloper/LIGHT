...
namespace HomeAutomation
{
    ...
    class LightControlAnteRoomNG : LightControlNG
    {
        ...
        public void SwitchDeviceViaPresenceDetector( bool command, double delayTimeOff, int deviceindex )
        {
            bool enable = false;
    ...
    class AnteRoom : CommonRoom
    {
        ...
        {
            if( LightAnteRoom != null && LightBathRoom != null && LightWashRoom != null  )
            {
                LightAnteRoom.StateDigitalOutput = base.StateDigitalOutput;
                LightBathRoom.StateDigitalOutput = base.StateDigitalOutput;
                ...
                switch( e.Index ) // the index is the assigned input number
                {
                        ...
                        case AnteRoomIOAssignment.indWashRoomMainButton:
                             ...
                             LightWashRoom.AutomaticOffSelect( e, WashRoomIODeviceIndices.indDigitalOutputWashRoomLight );
                             break;
